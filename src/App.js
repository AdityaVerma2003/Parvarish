...
import Contactus from './component/cont/Contactus';
import G2 from './component/gallery/G2';
...
const App = () => {
  ...
  <Routes>
    ...
    <Route path="/gallery" Component={G2}/>
    ...
    <Route path="/cus" Component={Contactus}/>
    <Route path="/don" Component={Donation}/>
  </Routes>
  <Footer/>
  </>
  )
